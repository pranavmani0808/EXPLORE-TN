...
class PlacesService:
    def __init__(self):
        ...
        self._places_db: Dict[str, dict] = {
            ...
            "vivekananda-rock": {'id': 'p-vivekananda-rock', 'slug': 'vivekananda-rock', 'name': 'Vivekananda Rock Memorial', 'display_name': 'Vivekananda Rock Memorial & Thiruvalluvar Statue', 'type': 'HERITAGE_SITE', 'category': 'heritage', 'subcategory': 'monument', 'tagline': 'Sacred island rock monument at the confluence of Indian Ocean, Arabian Sea & Bay of Bengal', 'description': 'Constructed in 1970 on a rock island 500m off the mainland where Swami Vivekananda meditated in 1892, adjacent to the 133ft Thiruvalluvar Statue.', 'latitude': 8.0781, 'longitude': 77.5554, 'city': 'Kanyakumari', 'district': 'Kanyakumari', 'state': 'Tamil Nadu', 'country': 'India', 'region': 'Triveni Sangam', 'aliases': ['vivekananda rock', 'kanyakumari rock memorial', 'thiruvalluvar statue'], 'search_terms': ['kanyakumari', 'vivekananda', 'triveni sangam', 'ferry', 'monument'], 'activities': ['ferry_ride', 'sunrise_sunset_viewing', 'spiritual', 'monuments'], 'tags': ['triveni_sangam', 'monument', 'island'], 'image': 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?auto=format&fit=crop&w=1000&q=80', 'rating': 4.9, 'popularity': 99, 'coordinate_source': 'Government of Tamil Nadu Tourism Portal', 'coordinate_accuracy': 'EXACT', 'verified': True},
