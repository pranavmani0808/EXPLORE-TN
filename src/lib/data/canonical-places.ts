...
export const CANONICAL_PLACES: ExplorerPlace[] = [
  ...
  // --- ARUPADAI VEEDU SACRED CIRCUIT (6 SACRED MURUGAN TEMPLES) ---
  {
    id: "thirupparankundram-murugan-temple",
    ...
    categories: ["temples", "heritage", "tourist-places"],
    primaryCategory: "temples",
    tagline: "1st Arupadai Veedu — 6th-century rock-cut cave shrine celebrating Murugan's wedding",
    ...
    verified: true,
    source: "ExplorerTN Canonical Catalog",
    tags: ["Arupadai Veedu", "Rock-Cut", "Cave Temple", "Murugan", "Granite Hill"],
    highlights: ["6th-Century Rock-Cut Shrine", "Granite Hill Viewpoint", "1st Arupadai Veedu"],
    aliases: ["thirupparankundram-temple", "Thirupparankundram", "Thiruparankundram"],
  },
  {
    id: "tiruchendur-murugan-temple",
    canonicalName: "Tiruchendur Murugan Temple",
    ...
    description: "The only Arupadai Veedu shrine located right on the seashore of the Gulf of Mannar in Tiruchendur, Thoothukudi district.",
    image: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=1000&q=80",
    rating: 4.9,
    reviewsCount: 8920,
    verified: true,
    source: "ExplorerTN Canonical Catalog",
    tags: ["Arupadai Veedu", "Seashore Temple", "Murugan", "Tiruchendur"],
    highlights: ["Seashore Shrine", "Surasamharam Site", "2nd Arupadai Veedu"],
    aliases: ["Tiruchendur", "Tiruchendur Temple", "Tiruchendur Murugan"],
  },
  {
    ...
    latitude: 10.4497,
    longitude: 77.5204,
    categories: ["temples", "hills", "heritage"],
    primaryCategory: "temples",
    tagline: "3rd Arupadai Veedu — Sacred Sivagiri hill abode of Lord Dhandayuthapani Swamy",
    description: "Perched atop the steep Sivagiri hill in Palani, Dindigul district, this world-renowned shrine houses the sacred Navapashanam idol.",
    image: "https://images.unsplash.com/photo-1609946782701-791789c67676?auto=format&fit=crop&w=1000&q=80",
    rating: 4.9,
    reviewsCount: 12400,
    verified: true,
    source: "ExplorerTN Canonical Catalog",
    tags: ["Arupadai Veedu", "Navapashanam", "Sivagiri Hill", "Murugan", "Palani"],
    highlights: ["Navapashanam Idol", "Sivagiri Hilltop Ropeway", "3rd Arupadai Veedu"],
    aliases: ["Palani", "Palani Temple", "Dhandayuthapani Swamy"],
  },
  {
    id: "swamimalai-murugan-temple",
    canonicalName: "Swamimalai Murugan Temple",
    ...
    description: "Situated on a 60-foot artificial hillock near Kumbakonam, Swamimalai features 60 steps representing the 60 Tamil calendar years.",
    image: "https://images.unsplash.com/photo-1582510003544-4d00b7f74220?auto=format&fit=crop&w=1000&q=80",
    rating: 4.8,
    reviewsCount: 4150,
    verified: true,
    source: "ExplorerTN Canonical Catalog",
    tags: ["Arupadai Veedu", "Pranava Mantra", "Swaminatha Swami", "Thanjavur"],
    highlights: ["60 Tamil Year Steps", "Pranava Mantra Teaching Site", "4th Arupadai Veedu"],
    aliases: ["Swamimalai", "Swaminatha Swami Temple"],
  },
  {
    id: "thiruttani-murugan-temple",
    canonicalName: "Thiruthani Murugan Temple",
    ...
    description: "Located on Tanigai hill in Tiruvallur district, Thiruttani Murugan Temple features 365 steps representing each day of the year.",
    image: "https://images.unsplash.com/photo-1621847468516-1ed5d0df56fe?auto=format&fit=crop&w=1000&q=80",
    rating: 4.8,
    reviewsCount: 5200,
    verified: true,
    source: "ExplorerTN Canonical Catalog",
    tags: ["Arupadai Veedu", "Tanigai Hill", "365 Steps", "Murugan", "Tiruvallur"],
    highlights: ["365 Hill Steps", "Tanigai Hill View", "5th Arupadai Veedu"],
    aliases: ["thiruthani-murugan-temple", "Thiruttani", "Tiruttani Murugan Temple"],
  },
  {
    id: "pazhamudircholai-murugan-temple",
    ...
    description: "Nestled amidst dense evergreen forests atop the Solaimalai hill range near Alagar Kovil in Madurai district.",
    image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1000&q=80",
    rating: 4.8,
    reviewsCount: 3100,
    verified: true,
    source: "ExplorerTN Canonical Catalog",
    tags: ["Arupadai Veedu", "Solaimalai", "Forest Temple", "Murugan", "Madurai"],
    highlights: ["Hilltop Forest Shrine", "Solaimalai Mountain Road", "6th Arupadai Veedu"],
    aliases: ["pazhamudircholai-temple", "Solaimalai Murugan Temple", "Pazhamudhircholai"],
  },
  {
    id: "samanar-hills",
