...
const HIGHWAY_RECS_CATALOG = [
  ...
  // ECR Highway Corridor (Chennai -> Mahabalipuram -> Kalpakkam -> Marakkanam -> Pondicherry)
  {
  ...
  {
    id: "ecr-bamboo-drive-in-kalpakkam",
    name: "ECR Ocean Drive-In & Seafood — Kalpakkam",
    district: "Chengalpattu",
    latitude: 12.5020,
    longitude: 80.1600,
    category: "lunch" as RouteStopCategory,
    tagline: "Fresh coastal seafood thali, grilled fish & ocean view dining",
    rating: 4.7,
    reviewsCount: 3800,
    openTime: "11:30",
    closeTime: "22:30",
  ...
  {
    id: "ecr-marakkanam-salt-pans-cafe",
    name: "Marakkanam Backwater Tea & Cafe — ECR",
    district: "Villupuram",
    latitude: 12.1960,
    longitude: 79.9530,
    category: "tea" as RouteStopCategory,
    tagline: "Scenic salt pan view coffee stop, traditional snacks & tender coconut",
    rating: 4.5,
    reviewsCount: 2900,
    openTime: "06:00",
    closeTime: "21:00",
  ...
  {
    id: "ecr-shell-covelong-fuel",
    name: "Shell ECR Fuel & Rest Stop — Kovelong Junction",
    district: "Chengalpattu",
    latitude: 12.7910,
    longitude: 80.2450,
    category: "fuel" as RouteStopCategory,
    tagline: "Clean rest areas, EV fast charging, premium V-Power fuel & convenience store",
    rating: 4.7,
    reviewsCount: 4200,
    openTime: "00:00",
    closeTime: "23:59",
